...
export * from "https://deno.land/x/denops_std@v3.9.3/test/mod.ts";
export * as vars from "https://deno.land/x/denops_std@v3.9.3/variable/mod.ts";
export * as mapping from "https://deno.land/x/denops_std@v3.9.3/mapping/mod.ts";
export * from "https://deno.land/x/denops_std@v3.9.3/mapping/types.ts";
